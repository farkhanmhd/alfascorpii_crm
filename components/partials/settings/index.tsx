...
import { themeControllerAtom } from "@/store/theme";
...
const Settings = () => {
  ...
  const [openController, setOpenController] = useAtom(themeControllerAtom);
  ...
  return (
    <div>
      ...
      <Transition as={Fragment} show={openController}>
        <div
