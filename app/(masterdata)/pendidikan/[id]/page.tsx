...
const Page = () => {
  ...
  const selectedPendidikan = pendidikan.find((leasing) => leasing.id === Number(id));

  const [selectedStatus, setSelectedStatus] = useState(selectedPendidikan.status);
  const pendidikanValue = selectedPendidikan.pendidikan;
  const pendidikanKode = selectedPendidikan.kode;
